...
(function($, my) {
  ...
  my.API_ENDPOINT = 'http://www.opendata-hro.de/api';
...
my.Graph = Backbone.View.extend({
  template: ' \
    <div class="recline-graph" style="margin-right:225px"> \
      <div class="panel graph" style="display:block;text-align:justify"> \
        <div class="js-temp-notice alert alert-block"> \
          <p>Es wird hier kein Diagramm angezeigt, da noch unklar ist, welche Felder für seine Erstellung herangezogen werden sollen.</p> \
          <p>Sobald Sie die Felder für das Diagramm über das <strong>Menü rechts</strong> festgelegt haben, wird das Diagramm automatisch gezeichnet.</p> \
        </div> \
      </div> \
    </div> \
',
  ...
  redraw: function() {
    ...
    if (this.state.get('group') && this.state.get('series')) {
      ...
      this.$graph.width(this.el.width() - 225);
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="input editor-type"> \
          <select> \
          <option value="lines-and-points">Linien mit Punkten</option> \
          <option value="lines">Linien</option> \
          <option value="points">Punkte</option> \
          <option value="bars">Balken</option> \
          <option value="columns">Säulen</option> \
          </select> \
        </div> \
        <label>Abszisse (x-Achse)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn editor-add">Ordinate hinzufügen</button> \
      </div> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <label>Ordinate <span>{{seriesName}} (y-Achse)</span> \
...
',
  ...
  geometryFieldNames: ['geojson', 'geom','the_geom','geometry','geometrie_wkt','spatial','location', 'geo', 'lonlat'],
  ...
  _zoomToFeatures: function(){
    ...
    if (bounds){
      ...
      this.map.setView(new L.LatLng(54.1473507513394, 12.1410351395582), 10);
    }
  },
  ...
  _setupMap: function(){
    ...
    var mapUrl = "http://geo.sv.rostock.de/geodienste/stadtplan/tiles/1.0.0/stadtplan_EPSG3857/{z}/{x}/{y}.png?origin=nw";
    var osmAttribution = 'Kartenbild © Hansestadt Rostock (<a target="_blank" href="http://creativecommons.org/licenses/by/3.0/deed.de">CC BY 3.0</a>) | Kartendaten © <a target="_blank" href="http://www.openstreetmap.org">OpenStreetMap</a> (<a target="_blank" href="http://opendatacommons.org/licenses/odbl/">ODbL</a>) und <a target="_blank" href="https://geo.sv.rostock.de/uvgb.html">uVGB-MV</a>';
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="editor-field-type"> \
            <label class="radio"> \
              ...
              Latitude-/Longitude-Felder</label> \
            <label class="radio"> \
              <input type="radio" id="editor-field-type-geom" name="editor-field-type" value="geom" /> \
              GeoJSON-Feld</label> \
        </div> \
        <div class="editor-field-type-latlon"> \
          <label>Latitude-Feld</label> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Feld mit GeoJSON-Geometrie</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn editor-update-map">Karte aktualisieren</button> \
      </div> \
      <br /> \
      <div class="editor-options" > \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-auto-zoom" checked="checked" /> \
          auf Kartenelemente zoomen</label> \
      </div> \
...
//     label: 'Tabelle', // used for view switcher
  ...
  <div class="recline-data-explorer"> \
    ...
    <div class="header"> \
      ...
      <div class="recline-results-info"> \
        <span class="doc-count">{{recordCount}}</span> Einträge\
      </div> \
  ...
  template: ' \
    <form action="" method="GET" class="form-inline"> \
      <div class="input-prepend text-query"> \
        ...
        <input type="text" name="q" value="{{q}}" class="span2" placeholder="Daten suchen…" class="search-query" /> \
      </div> \

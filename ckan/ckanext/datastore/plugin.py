    ...
    def _is_read_only_database(self):
        ...
        for url in [self.ckan_url, self.write_url, self.read_url]:
            ...
            try:
                ...
                if 'permission denied' in str(e) or 'read-only transaction' in str(e) or 'keine Berechtigung' in str(e):
                    pass
                else:
                    raise
            else:
        ...
        try:
            for sql in statements:
                ...
                try:
                    ...
                    if 'permission denied' not in str(e) and 'keine Berechtigung' not in str(e):
                        raise
                else:

...
def make_map():
    ...
    map.connect('help', '/help', controller='home', action='help')
    map.connect('imprint', '/imprint', controller='home', action='imprint')
    map.connect('privacy_policy', '/privacy_policy', controller='home', action='privacy_policy')
    map.connect('terms_of_use', '/terms_of_use', controller='home', action='terms_of_use')
    map.connect('usage', '/usage', controller='home', action='usage')
